...
root = Tk()
root.wm_title("Disease Predictor")
root.configure(background='white')
Symptom1 = StringVar()
Symptom1.set("Choose Option")
Symptom2 = StringVar()
Symptom2.set("Choose Option")
Symptom3 = StringVar()
Symptom3.set("Choose Option")
Symptom4 = StringVar()
Symptom4.set("Choose Option")
Symptom5 = StringVar()
Symptom5.set("Choose Option")
Name = StringVar()
#w2 = Label(root, justify=CENTER, text="Disease Predictor", fg="white", bg="black")
#w2.config(font=("Times",16,"bold"))
#w2.grid(row=1, column=1, padx=100)
...
lrLb = Label(root, text="Predicted Disease:", fg="black")
...
dst.config(font=("poppins",10,"bold"))
dst.grid(row=9, column=3,padx=10)
t1 = Text(root, height=1, width=20,bg="white",fg="black")
